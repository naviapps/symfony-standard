...
use AppBundle\Form\Admin\OrderType;
...
class OrderController extends Controller
{
    ...
    public function indexAction(Request $request, PaginatorInterface $paginator): Response
    {
        ...
        $query = $em->createQuery('SELECT o FROM AppBundle:Order o');
        ...
        return $this->render('admin/order/index.html.twig', ['pagination' => $pagination]);
    }
