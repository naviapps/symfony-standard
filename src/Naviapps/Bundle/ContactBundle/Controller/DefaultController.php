...
namespace Naviapps\Bundle\ContactBundle\Controller;

use Naviapps\Bundle\ContactBundle\Form\ContactFlow;
...
class DefaultController extends Controller
{
     ...
     * @return Response
     *
     * @Route("/", name="naviapps_contact_index")
     */
    public function indexAction(ContactFlow $flow): Response
    {
        ...
        if ($form->isSubmitted() && $flow->isValid($form)) {
            ...
            if ($flow->nextStep()) {
                ...
                return $this->redirectToRoute('naviapps_contact_index');
            }
        }

        return $this->render('@NaviappsContact/Default/index.html.twig', [
