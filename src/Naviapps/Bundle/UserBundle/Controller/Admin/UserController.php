...
class UserController extends Controller
{
     ...
     * @return Response
     *
     * @Route("/", name="naviapps_user_admin_user_index")
     * @Method("GET")
     */
    public function indexAction(Request $request, PaginatorInterface $paginator): Response
    {
        $em = $this->getDoctrine()->getManager();
        $query = $em->createQuery('SELECT u FROM NaviappsUserBundle:User u');
     ...
     * @return Response
     *
     * @Route("/new", name="naviapps_user_admin_user_new")
     * @Method({"GET", "POST"})
     */
     ...
     * @return Response
     *
     * @Route("/{id}/edit", requirements={"id": "\d+"}, name="naviapps_user_admin_user_edit")
     * @Method({"GET", "POST"})
     ...
     * @return Response
     *
     * @Route("/{id}/delete", name="naviapps_user_admin_user_delete")
     * @Method("POST")
